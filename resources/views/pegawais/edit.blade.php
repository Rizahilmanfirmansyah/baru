        ...
        <div class="card" style="width: 50rem;">
            ...
            <form method="post" action="{{ route('pegawais.update',$pegawai->id) }}" enctype="multipart/form-data" id="myForm">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" value="{{$pegawai->jabatan}}" style="width: 100%" name="jabatan" id="jabatan">
            ...
            -->
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" value="{{$pegawai->status}}" style="width: 100%" name="status">
